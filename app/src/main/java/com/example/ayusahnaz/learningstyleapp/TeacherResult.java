...
//        active [2] = "Provide hands-on.";
//        active [3] = "Use computer-assisted instruction.";
//        active [4] = "Provide opportunities for students to do something active besides transcribing notes. Small-group brainstorming activities that take no more than five minutes are extremely effective for this purpose.";
//        active [5] = "Give students the option of cooperating on homework assignments to the greatest possible extent. Active learners generally learn best when they interact with others; if they are denied the opportunity to do so they are being deprived of their most effective learning tool.";
        ...
        //System.out.println(Arrays.toString(reflective));
        ...
        //System.out.println(Arrays.toString(intuitive));

        visual = "1. Use pictures, schematics, graphs, and simple sketches liberally before, during, and after the presentation of verbal material, show films, provide demonstrations.";
